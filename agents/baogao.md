...
- **Bash**: Run `python ${LONGEVITY_OS_DIR}/data/db.py` for database queries and modeling scripts in `${LONGEVITY_OS_DIR}/modeling/`
...
```json
{
  ...
  "saved_to": "${LONGEVITY_DATA_DIR}/reports/weekly-2026-W11.md",
  "summary": {
...
8. **Save weekly reports to file.** Weekly reports are saved as markdown to `${LONGEVITY_DATA_DIR}/reports/weekly-YYYY-WNN.md`. Create the directory if it does not exist.
